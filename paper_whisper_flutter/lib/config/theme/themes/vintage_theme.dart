...
final vintageTheme = PaperWhisperTheme(
  ...
  settings: SettingsThemeData(
    groupDecoration: BoxDecoration(
      ...
      border: Border.all(color: _vintagePaper.withValues(alpha: 0.1)),
      boxShadow: [
        BoxShadow(
    ...
    dividerColor: _vintagePaper.withValues(alpha: 0.1),
    textColor: _vintagePaper,
    activeSwitchColor: _vintageAccent,
    activeTrackColor: _vintageAccent.withValues(alpha: 0.3),
    ...
    iconColor: _vintagePaper.withValues(alpha: 0.8),
    showPetalRain: false,
    showStarrySky: false,
  ...
  momentCard: MomentCardThemeData(
    ...
    indicatorInactiveColor: const Color(0xFFBCAAA4).withValues(alpha: 0.7),
    watermarkDividerColor: Colors.black.withValues(alpha: 0.05),
    audioSurfaceColor: const Color(0xFF5D4037).withValues(alpha: 0.08),
    audioSurfaceBorderColor: const Color(0xFF5D4037).withValues(alpha: 0.15),
    ...
    deleteIconColor: const Color(0xFF8D6E63).withValues(alpha: 0.75),
  ),
  ...
  moments: MomentsThemeData(
    ...
    rulerInactiveTextColor: const Color(0xFFD7CCC8).withValues(alpha: 0.3),
    rulerSubTextColor: _vintageAccent,
    rulerInactiveSubTextColor: _vintageAccent.withValues(alpha: 0.3),
    rulerIndicatorColor: _vintageAccent,
    rulerShadowColor: Colors.black.withValues(alpha: 0.3),
    rulerBorderColor: Colors.white.withValues(alpha: 0.08),
  ...
  mobileHeader: MobileHeaderColorsData(
    background: const Color(0xFF3e2723).withValues(alpha: 0.85),
    border: const Color(0xFF1a100d),
    iconColor: const Color(0xFFD7CCC8),
    titleColor: const Color(0xFFEEFFEB),
    subtitleColor: const Color(0xFFD7CCC8).withValues(alpha: 0.8),
  ),
  dialogInput: DialogInputThemeData(
    textColor: const Color(0xFF5D4037),
    hintColor: const Color(0xFF5D4037).withValues(alpha: 0.4),
    borderColor: const Color(0xFF5D4037).withValues(alpha: 0.2),
    focusedBorderColor: const Color(0xFF5D4037).withValues(alpha: 0.6),
    iconColor: const Color(0xFF5D4037).withValues(alpha: 0.4),
    backgroundColor: Colors.white.withValues(alpha: 0.5),
    descriptionColor: const Color(0xFF5D4037).withValues(alpha: 0.7),
  ),
  statistics: StatisticsThemeData(
    ...
    badgeStyle: StatisticsBadgeStyleData(
      backgroundColor: const Color(0xFFFF3D00).withValues(alpha: 0.15),
      textColor: const Color(0xFFFF3D00),
      borderColor: const Color(0xFFFF3D00).withValues(alpha: 0.3),
    ),
  ),
  trashPage: TrashPageThemeData(
    ...
    cardDateColor: const Color(0xFF5D4037).withValues(alpha: 0.6),
  ...
  syncSettings: SyncSettingsThemeData(
    ...
    switchInactiveText: const Color(0xFF5D4037).withValues(alpha: 0.5),
    primaryBtnColor: const Color(0xFF5D4037),
    primaryShadowColor: Colors.black26,
    secondaryBtnColor: Colors.white.withValues(alpha: 0.2),
  ...
  momentInput: MomentInputThemeData(
    ...
    miniCassetteDeleteColor: const Color(0xFFA1887F).withValues(alpha: 0.8),
  ),
