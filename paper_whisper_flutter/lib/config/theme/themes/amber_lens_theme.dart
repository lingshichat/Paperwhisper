...
final amberLensTheme = PaperWhisperTheme(
  ...
  settings: SettingsThemeData(
    ...
    activeTrackColor: _amberAccent.withValues(alpha: 0.25),
    ...
    sheetShowTape: false,
    sheetInfoBackgroundColor: Colors.white.withValues(alpha: 0.08),
    sheetInfoBorderColor: _amberAccent.withValues(alpha: 0.2),
    sheetInfoDividerColor: _amberAccent.withValues(alpha: 0.15),
  ...
  diaryCard: DiaryCardThemeData(
    bgColor: const Color(0xFF1E1E1E).withValues(alpha: 0.95),
  ...
  momentCard: MomentCardThemeData(
    ...
    deleteIconColor: _amberAccent.withValues(alpha: 0.75),
  ),
  bookDirectory: const BookDirectoryThemeData(),
  moments: MomentsThemeData(
    rulerBg: const Color(0xFF1E1E1E).withValues(alpha: 0.95),
    rulerTextColor: _amberTextSecondary,
    rulerInactiveTextColor: _amberTextSecondary.withValues(alpha: 0.3),
    rulerSubTextColor: _amberAccent,
    rulerInactiveSubTextColor: _amberAccent.withValues(alpha: 0.3),
    rulerIndicatorColor: _amberAccent,
    rulerShadowColor: Colors.black.withValues(alpha: 0.3),
    rulerBorderColor: _amberAccent.withValues(alpha: 0.15),
    appBarIconColor: Colors.white70,
    appBarTextColor: Colors.white,
    drawerScrimColor: Colors.black54,
    appBarBg: const Color(0xFF1E1E1E).withValues(alpha: 0.5),
    emptyStateIconColor: _amberTextSecondary.withValues(alpha: 0.72),
  ...
  mobileHeader: MobileHeaderColorsData(
    background: const Color(0xFF1E1E1E).withValues(alpha: 0.9),
  ...
  dialogInput: DialogInputThemeData(
    textColor: _amberTextPrimary,
    hintColor: _amberTextSecondary.withValues(alpha: 0.5),
    borderColor: _amberAccent.withValues(alpha: 0.4),
    focusedBorderColor: _amberAccent,
    iconColor: _amberAccent.withValues(alpha: 0.6),
  ...
  trashPage: TrashPageThemeData(
    ...
    cardDateColor: const Color(0xFFE0E0E0).withValues(alpha: 0.6),
