...
final gardenOfWordsTheme = PaperWhisperTheme(
  ...
  fab: FabThemeData(
    ...
    shadow: BoxShadow(
      color: _accentDark.withOpacity(0.5),
      blurRadius: 16,
  ...
  settings: SettingsThemeData(
    ...
    sheetShowTape: false,
    sheetInfoBackgroundColor: _surface.withOpacity(0.45),
    sheetInfoBorderColor: _accent.withOpacity(0.2),
    sheetInfoDividerColor: _accent.withOpacity(0.15),
  ...
  diaryCard: DiaryCardThemeData(
    bgColor: const Color(0xFF455A64).withOpacity(0.3),
  ...
  bookDirectory: BookDirectoryThemeData(
    ...
    paperBorderColor: _accent.withOpacity(0.3),
    paperShadow: [
      BoxShadow(
  ...
  moments: MomentsThemeData(
    ...
    rulerInactiveSubTextColor: _accent.withOpacity(0.4),
  ...
  search: SearchThemeData(
    bgColor: const Color(0xFF263238).withOpacity(0.5),
  ...
  monthDivider: MonthDividerThemeData(
    textColor: _textPrimary,
    lineColor: _accent.withOpacity(0.4),
  ...
  dialog: AppDialogThemeData(
    ...
    text: _textSecondary,
    icon: _accentDark,
    tape: Colors.white.withOpacity(0.5),
  ...
  lockScreen: LockScreenThemeData(
    displayBg: _surface.withOpacity(0.3),
    displayBorder: _accent.withOpacity(0.3),
    accentColor: _accent,
    keyBg: _surface.withOpacity(0.4),
    keyBorder: _accent.withOpacity(0.2),
    keyText: _textSecondary,
  ),

  // --- Mobile Header ---
  mobileHeader: MobileHeaderColorsData(
    background: _surface.withOpacity(0.9),
    border: _accent.withOpacity(0.3),
  ...
  dialogInput: DialogInputThemeData(
    ...
    iconColor: _accent.withOpacity(0.6),
    backgroundColor: Colors.black.withOpacity(0.2),
    descriptionColor: _textPrimary.withOpacity(0.7),
  ),
  ...
  momentEditor: MomentEditorThemeData(
    bgColor: _surface.withOpacity(0.95),
    ...
    photoEmptyColor: _accent.withOpacity(0.1),
