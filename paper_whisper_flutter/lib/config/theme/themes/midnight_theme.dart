...
final midnightTheme = PaperWhisperTheme(
  ...
  editor: EditorThemeData(
    appBarBg: const Color(0xFF0D1117).withOpacity(0.9),
  ...
  momentCard: MomentCardThemeData(
    cardColor: const Color(0xFF161B22).withOpacity(0.95),
    ...
    cardShadows: [
      ...
      BoxShadow(
        color: _midnightAccent.withOpacity(0.16),
    ...
    indicatorInactiveColor: Colors.white.withOpacity(0.18),
    watermarkDividerColor: Colors.white.withOpacity(0.1),
    audioSurfaceColor: const Color(0xFF0D1117).withOpacity(0.72),
    ...
    audioProgressColor: _midnightAccent.withOpacity(0.7),
    audioDurationColor: _midnightTextSecondary.withOpacity(0.9),
    deleteIconColor: _midnightAccent.withOpacity(0.75),
  ),
  ...
  momentInput: MomentInputThemeData(
    ...
    cassetteWindowBorderColor: const Color(0xFF7986CB).withOpacity(0.45),
    ...
    miniCassetteDeleteColor: const Color(0xFF8B949E).withOpacity(0.8),
  ),
