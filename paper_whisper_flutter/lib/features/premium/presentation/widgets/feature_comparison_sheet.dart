    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: col1Width,
            child: Text("功能特性", style: _headerStyle()),
          ),
          SizedBox(
            width: colWidth,
            child: Center(
          ...
          SizedBox(
            ...
            child: Center(
              child: Text(
                "功能特性赞助\n(买断)",
                textAlign: TextAlign.center,
                style: _headerStyle().copyWith(color: const Color(0xFFD84315)),
              ),
            ),
          ),
          SizedBox(
            ...
            child: Center(
              child: Text(
                "订阅赞助\n(订阅)",
                textAlign: TextAlign.center,
                style: _headerStyle().copyWith(color: const Color(0xFF1565C0)),
              ),
            ),
          ),
        ],
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              v2,
              textAlign: TextAlign.center,
              style: _valueStyle().copyWith(fontWeight: FontWeight.bold),
            ),
          ),
          SizedBox(
            width: colWidth,
