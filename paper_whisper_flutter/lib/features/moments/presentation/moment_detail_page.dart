    ...
    try {
      ...
      if (doSplit) {
        ...
        while (y < src.height) {
          ...
          String fileName =
              '${prefix}_${DateTime.now().millisecondsSinceEpoch}_part$partIndex.jpg';
        ...
        children: [
          ...
          Positioned(
            ...
            child: Center(
              child: Material(
                elevation:
                    24, // High elevation to ensure it's above 3D perspective content
                color: Colors.transparent,
      ...
      child: RepaintBoundary(
        ...
        child: Container(
          margin: const EdgeInsets.all(
            32,
          ), // Match margin to keep size roughly similar
