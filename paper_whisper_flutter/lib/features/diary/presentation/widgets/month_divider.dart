...
class MonthDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color paperColor =
        dividerTheme.paperColor ??
        (theme == AppTheme.themeMidnight
            ? const Color(0xFF283593)
            : (theme == AppTheme.themeTwilight
                  ? const Color(0xFF352044).withValues(alpha: 0.6)
                  : (theme == AppTheme.themeSeaFlower
                        ? const Color(0xFFFCE4EC).withValues(alpha: 0.9)
                        : (theme == AppTheme.themeAmberLens
                              ? const Color(0xFFFFF8E1)
                              : const Color(0xFFEFEBE9)))));
    List<BoxShadow> shadows =
        dividerTheme.shadows ??
        (theme == AppTheme.themeMidnight
            ? [
                BoxShadow(
    ...
    return Container(
      ...
      child: Row(
        // Use Row instead of Stack to prevent line crossing
