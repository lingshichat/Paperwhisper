...
class MonthDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<BoxShadow> shadows = (themeConfig.isNotEmpty && themeConfig['shadows'] != null) ? themeConfig['shadows'] : (theme == AppTheme.themeMidnight ? [BoxShadow(color: Colors.black.withValues(alpha: 0.4), blurRadius: 4, offset: const Offset(0, 2))] : (theme == AppTheme.themeTwilight ? [BoxShadow(color: const Color(0xFFEF5350).withValues(alpha: 0.15), blurRadius: 4, offset: const Offset(0, 2))] : (theme == AppTheme.themeSeaFlower ? [] : (theme == AppTheme.themeAmberLens ? [BoxShadow(color: const Color(0xFF3E2723).withValues(alpha: 0.1), blurRadius: 3, offset: const Offset(0, 1))] : [BoxShadow(color: const Color(0xFF5D4037).withValues(alpha: 0.15), blurRadius: 4, offset: const Offset(0, 2))]))));
