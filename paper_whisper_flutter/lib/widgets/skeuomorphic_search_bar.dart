...
class _SkeuomorphicSearchBarState extends State<SkeuomorphicSearchBar> {
  ...
  Widget build(BuildContext context) {
    ...
    Color bgColor = themeConfig.isNotEmpty ? themeConfig['bgColor'] : (theme == AppTheme.themeSeaFlower ? const Color(0xFFF8BBD0).withValues(alpha: 0.3) : (theme == AppTheme.themeMidnight ? const Color(0xFF010409) : (theme == AppTheme.themeAmberLens ? const Color(0xFF1E1E1E) : (theme == AppTheme.themeTwilight ? const Color(0xFF352044).withValues(alpha: 0.4) : const Color(0xFF2D1E1B)))));
    ...
    Color hintColor = themeConfig.isNotEmpty ? themeConfig['hintColor'] : (theme == AppTheme.themeSeaFlower ? const Color(0xFFAD1457).withValues(alpha: 0.5) : (theme == AppTheme.themeMidnight ? const Color(0xFF8b949e) : (theme == AppTheme.themeAmberLens ? const Color(0xFF757575) : (theme == AppTheme.themeTwilight ? const Color(0xFFE4E0EC).withValues(alpha: 0.5) : const Color(0xFFA1887F)))));
