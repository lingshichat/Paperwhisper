...
class _BookFlipRefreshWidgetState extends State<BookFlipRefreshWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final Color bookColor = isSeaFlower 
        ...
        : (isMidnight ? const Color(0xFF5C6BC0) : (isAmber ? const Color(0xFFFF6F00) : (widget.theme == AppTheme.themeAfterRain ? const Color(0xFF0288D1) : (widget.theme == AppTheme.themeTwilight ? const Color(0xFF2E1A3C) : const Color(0xFF6D4C41)))));
    final Color pageColor = isSeaFlower
        ? const Color(0xFFFCE4EC)
        : (isMidnight ? const Color(0xFFE8EAF6) : (isAmber ? const Color(0xFF424242) : (widget.theme == AppTheme.themeAfterRain ? const Color(0xFFF0F8FF) : (widget.theme == AppTheme.themeTwilight ? const Color(0xFF352044) : const Color(0xFFFAF8F5)))));
    final Color textColor = isSeaFlower
        ? const Color(0xFFAD1457)
        : (isMidnight ? const Color(0xFFB0BEC5) : (isAmber ? const Color(0xFFFFB74D) : (widget.theme == AppTheme.themeAfterRain ? const Color(0xFF455A64) : (widget.theme == AppTheme.themeTwilight ? const Color(0xFF4DD0E1) : const Color(0xFF8D6E63)))));
