...
class BookDirectoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color inkColor = bookTheme.inkColor ?? (theme == AppTheme.themeMidnight ? Colors.white : (theme == AppTheme.themeSeaFlower ? const Color(0xFFC2185B) : (theme == AppTheme.themeAmberLens ? const Color(0xFF3E2723) : const Color(0xFF680000))));
    Color paperColor = bookTheme.paperColor ?? (theme == AppTheme.themeMidnight ? const Color(0xFF1A237E).withValues(alpha: 0.6) : (theme == AppTheme.themeSeaFlower ? const Color(0xFFFFFFFF).withValues(alpha: 0.7) : (theme == AppTheme.themeAmberLens ? const Color(0xFFFFF8E1).withValues(alpha: 0.85) : const Color(0xFFFFFDE7).withValues(alpha: 0.95))));
    Color paperBorderColor = bookTheme.paperBorderColor ?? (theme == AppTheme.themeMidnight ? const Color(0xFF5C6BC0).withValues(alpha: 0.3) : (theme == AppTheme.themeSeaFlower ? const Color(0xFFFCE4EC) : (theme == AppTheme.themeAmberLens ? const Color(0xFFFFECB3) : const Color(0xFFFFCDD2).withValues(alpha: 0.5))));
    List<BoxShadow> paperShadow = bookTheme.paperShadow ?? (theme == AppTheme.themeMidnight ? [BoxShadow(color: Colors.black.withValues(alpha: 0.5), blurRadius: 8, offset: const Offset(0, 4))] : (theme == AppTheme.themeSeaFlower ? [BoxShadow(color: const Color(0xFFF06292).withValues(alpha: 0.1), blurRadius: 4, offset: const Offset(0, 2))] : (theme == AppTheme.themeAmberLens ? [BoxShadow(color: const Color(0xFF3E2723).withValues(alpha: 0.15), blurRadius: 4, offset: const Offset(0, 2))] : [BoxShadow(color: const Color(0xFFB71C1C).withValues(alpha: 0.1), blurRadius: 4, offset: const Offset(0, 2))])));
